...
class model_wrapper():
    ...
    def __init__(self, 
        ...
        self.train_loss_dict = {'loss': []}
        self.val_loss_dict = {'loss': []}
        self.train = False
        self.val = False
    ...
    def fit(self,
        ...
        for epoch in range(initial_epoch, initial_epoch + epochs):
            ...
            self.train_loss_dict['loss'].append(np.mean(train_losses))
            ...
            if validation_data is not None:
                ...
                self.val_loss_dict['loss'].append(loss.cpu().detach().numpy())
        ...
        if verbose == 1:
            ...
            if self.save_best_val:
                ...
                idx = np.argmin(self.train_loss_dict['loss'])
            else:
                idx = -1
            p = 'Epoch {0}'.format(epoch)
