...
from modules.genetic_algorithm.ga_score_function import (score_function, 
...
toolbox.register('individual', custom_individual, creator.Individual,
                poly_terms, hill_terms, num_nonzero_terms, coef_bounds)
toolbox.register('population', tools.initRepeat, list, toolbox.individual)

# GENETIC OPERATORS:
# score function
toolbox.register('evaluate', score_function_helper, u_mesh=u_mesh,
                    v_mesh=v_mesh, poly_terms=poly_terms, 
                    hill_terms=hill_terms, F_mlp=F_mlp, F_true=F_true,
...
toolbox.register('mutate', custom_mutation_function, indpb=0.2, 
                ...
                hill_terms=hill_terms, coef_bounds=coef_bounds)
# selection function
