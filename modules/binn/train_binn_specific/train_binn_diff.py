...
from modules.binn.build_binns import BINN_diff
...
# params
training_data_path = "/work/users/s/m/smyersn/elston/projects/kinetics_binns/data/spikes_data.npz"
epsilon = 0
num_points = 500
...
animate_training_data(training_data_noise[:, :2], training_data_noise[:, 2:], save=True, name=f'{sys.argv[1]}/training_data')
