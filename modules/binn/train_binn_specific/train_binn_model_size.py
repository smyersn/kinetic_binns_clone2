...
dir_name = sys.argv[1]
model_name = f'layers_{layers}_neurons_{neurons}'

uv_layers = layers * [neurons] + [2]
...
model = model_wrapper(
    ...
    loss=binn.loss,
    augmentation=None,
    save_name=f'{dir_name}/{model_name}')

epochs = int(1e6)
#epochs = 100
batch_size = 2500 # 25% of split
