...
from modules.genetic_algorithm_locked.save_ga_results import write_terms
from modules.genetic_algorithm_locked.custom_deap_functions import (
    custom_individual, custom_mutation_function)
from modules.genetic_algorithm_locked.ga_score_function import (score_function, 
...
toolbox.register('individual', custom_individual, creator.Individual, coef_bounds)
toolbox.register('population', tools.initRepeat, list, toolbox.individual)

# GENETIC OPERATORS:
# score function
toolbox.register('evaluate', score_function_helper, u_mesh=u_triangle_mesh,
                    v_mesh=v_triangle_mesh, F_mlp=F_mlp, F_true=F_true,
