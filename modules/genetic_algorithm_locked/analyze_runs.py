...
from modules.genetic_algorithm_locked.plot_ga_results import (plot_best_ind_f_true, 
...
best_individuals = np.zeros((number_of_runs, 5))
...
for ind in range(len(best_individuals_sorted)):
    terms = write_terms(best_individuals_sorted[ind])
