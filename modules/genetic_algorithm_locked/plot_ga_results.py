...
def plot_best_ind_f_mlp(individual, u_mesh, v_mesh, F_true, F_mlp, dir_to_use):
    
    ga_surface = individual_to_surface(individual, u_mesh, v_mesh)
...
def plot_best_ind_f_true(individual, u_mesh, v_mesh, F_true, dir_to_use):
